...
```
cd existing_repo
git remote add origin https://git.cs.lth.se/dataflow/savina-apps-in-cal.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.lth.se/dataflow/savina-apps-in-cal/-/settings/integrations)
